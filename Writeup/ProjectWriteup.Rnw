...
These next few assumptions and thereoms establish the invariance of $p_\theta(x_{1:T}|y_{1:T})$ after the PIMH update and ergodicity of the PIMH sampler.
